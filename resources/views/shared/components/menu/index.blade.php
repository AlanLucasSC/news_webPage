...
<div class="fluid align-items-center sticky-top menu">
    <nav class="nav navbar-expand-lg d-flex bg-verde px-5">
        ...
        <button class="navbar-toggler mt-1 mx-5" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
